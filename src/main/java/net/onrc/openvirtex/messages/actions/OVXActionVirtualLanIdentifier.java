...
public class OVXActionVirtualLanIdentifier extends OFActionVirtualLanIdentifier
	...
	private final Logger log = LogManager
			.getLogger(OVXActionVirtualLanIdentifier.class.getName());
    ...
    public void virtualize(final OVXSwitch sw,
    	...
    	// modify by hujw
    	this.virtualLanIdentifier = Short.parseShort(sw.getTenantId().toString());
    	log.debug("Allocating VLAN ID {}", this.virtualLanIdentifier);
